...
model1 <- lmer(Cum_death ~ Order_stay + Order_mask + Cum_case + Pop_density + (1|State) + (1|Date) , data =data.frame)
summary(model1)
```
|    | Estimate | Std. Error | df | t value | Pr(>$|t|$) |
|:-:|:-:|:-:|:-:|:-:|:-:|
| Intercept | 1.851e+02 | 2.587e+02 | 5.032e+01 | 0.715 |0.478 |
| Order_stayYes | -2.237e+02 | 4.892e+01 | 1.887e+03 | -4.572 | 5.15e-06 *** |
| Order_maskYes | 4.940e+02 | 6.885e+01 | 7.514e+03 | 7.174 | 7.96e-13 *** |
| Cum_case | 3.878e-02 | 4.209e-04 | 6.935e+03 | 92.146 | < 2e-16 *** |
| Pop_density | 3.524e-01 | 3.686e-01 | 4.875e+01 | 0.956 | 0.344 |
...
ps <- glm(Order_stay ~ Cum_case + Unemp_num + Order_mask, data = data.frame, family = binomial())
summary(ps)
```
|    | Estimate | Std. Error | z value | Pr(>$|z|$) |
|:-:|:-:|:-:|:-:|:-:|:-:|
| Intercept | -2.773e+00      | 5.688e-02 | -48.751 | < 2e-16 *** |
| Order_maskYes |  -3.215e-01  | 1.147e-01 | -2.802 | 0.00507 ** |
| Cum_case | 5.309e-06 | 4.665e-07 |  11.380 | < 2e-16 *** |
| Unemp_num | 5.137e-05 | 1.201e-06|  42.766  | < 2e-16 *** |
...
```{r,echo=FALSE}
qqnorm(summary(model1)$residuals)
```
